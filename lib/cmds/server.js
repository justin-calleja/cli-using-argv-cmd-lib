...
var serverStartCmd = __importStar(require("./serverStart"));
var serverStopCmd = __importStar(require("./serverStop"));
exports.name = 'server';
exports.fqn = 'adhoc.server';
exports.subCmds = [serverStartCmd, serverStopCmd];
